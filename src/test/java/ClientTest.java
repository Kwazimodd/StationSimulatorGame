...
class ClientTest {
    ...
    void chooseCashRegister() {
        ...
        //cashRegisters.get(1).tryAddToQueue(new Client(4, 3000, ClientStatus.REGULAR));
        //cashRegisters.get(1).tryAddToQueue(new Client(5, 4000, ClientStatus.HAS_KIDS));
        ...
        //cashRegisters.get(2).tryAddToQueue(new Client(8, 4000, ClientStatus.HAS_KIDS));
